...
/* ========================================================================= */
/* 🗺️ E 分类 精简版 15 个项目【独立物理坐标控制中心 & 标题 8 字自动截断】 */
/* ========================================================================= */
const RAW_PROJECTS = [
  { id: "event-project01", name: "Project E1", thumb: "/thumbs/e1.jpg", ballPos: { x: 1.8, y: 1.4, z: 4.35 } },
  { id: "event-project02", name: "Project E2", thumb: "/thumbs/e2.jpg", ballPos: { x: -0.55, y: 0.7, z: 4.15 } },
  { id: "event-project03", name: "Project E3", thumb: "/thumbs/e3.jpg", ballPos: { x: 1.5, y: 0.3, z: 4.05 } },
  { id: "event-project04", name: "Project E4", thumb: "/thumbs/e4.jpg", ballPos: { x: -1.65, y: -1.7, z: 3.46 } },
  { id: "event-project05", name: "Project E5", thumb: "/thumbs/e5.jpg", ballPos: { x: -0.45, y: 2.15, z: 4.5 } },
  { id: "event-project06", name: "Project E6", thumb: "/thumbs/e6.jpg", ballPos: { x: 1.1, y: -1.05, z: 3.7 } },
  { id: "event-project07", name: "Project E7", thumb: "/thumbs/e7.jpg", ballPos: { x: -1.56, y: 0.2, z: 3.95 } },
  { id: "event-project08", name: "Project E8", thumb: "/thumbs/e8.jpg", ballPos: { x: 1.5, y: 0.3, z: 2.5 } },
  { id: "event-project09", name: "Project E9", thumb: "/thumbs/e9.jpg", ballPos: { x: -0.45, y: 2.15, z: 0.0 } },
  { id: "event-project10", name: "Project E10", thumb: "/thumbs/e10.jpg", ballPos: { x: 2.0, y: -1.2, z: 3.7 } },
  { id: "event-project11", name: "Project E11", thumb: "/thumbs/e11.jpg", ballPos: { x: -0.61, y: -0.22, z: 0.0 } },
  { id: "event-project12", name: "Project E12", thumb: "/thumbs/e12.jpg", ballPos: { x: 0.55, y: -1.85, z: 2.5 } },
  { id: "event-project13", name: "Project E13", thumb: "/thumbs/e13.jpg", ballPos: { x: -1.7, y: -2.9, z: 3.1 } },
  { id: "event-project14", name: "Project E14", thumb: "/thumbs/e14.jpg", ballPos: { x: 0.1, y: -0.9, z: 0.5 } },
  { id: "event-project15", name: "Project E15", thumb: "/thumbs/e15.jpg", ballPos: { x: 1.2, y: -1.0, z: 0.6 } },
];
        ...
        <div className="relative z-10 w-full px-8 md:pl-16 md:pr-12 border-b border-white/5 pb-8 mt-4 pointer-events-none flex flex-col items-start">
          ...
          <div className="max-w-[280px] md:max-w-[320px] block mt-[20px]">
            ...
            <div className="text-[16px] text-white/50 font-light tracking-wide leading-relaxed block mt-4">
              ...
              <br />
              are temporal and spatial event practices,
              <br />
              translating ephemeral interactions and
              <br />
              site-specific interventions into permanent
              <br />
