...
export default function ProjectPosterPage() {
  ...
  const PROJECT_DATA = {
    ...
    meta: {
      titlePngSrc: "/photo/g/p14/title.png",
      titles: { cn: "Project G14", en: "Project G14", jp: "Project G14" },
      projectName: "Project G14",
      creationDate: "2025",
      client: "TBD",
    },
    descriptions: {
      cn: ["项目 G14 的详细设计说明。", "更多信息待补充。"],
      en: ["Detailed description for Project G14.", "More information coming soon."],
      jp: ["プロジェクトG14の詳細説明。", "詳細は追って追記予定。"],
    },
    mainPosters: [
      "/photo/g/p14/gp14-001.png",
      "/photo/g/p14/gp14-002.png",
    ],
    sketches: [
      { id: 1, src: "/photo/g/p14/detail-01.jpg", width: 180, rotate: -8, top: "20px", left: "5%" },
      { id: 2, src: "/photo/g/p14/detail-02.jpg", width: 220, rotate: 6, top: "0px", left: "40%" },
      { id: 3, src: "/photo/g/p14/detail-03.jpg", width: 160, rotate: -12, top: "40px", left: "70%" },
    ]
  };
