...
/* ========================================================================= */
/* 🗺️ G 分类 精简版 15 个项目【独立物理坐标控制中心 & 标题 8 字自动截断】 */
/* ========================================================================= */
const RAW_PROJECTS = [
  { id: "graphic-project01", name: "Project G1", thumb: "/thumbs/g1.jpg", ballPos: { x: 1.8, y: 1.4, z: 4.35 } },
  { id: "graphic-project02", name: "Project G2", thumb: "/thumbs/g2.jpg", ballPos: { x: -0.55, y: 0.7, z: 4.15 } },
  { id: "graphic-project03", name: "Project G3", thumb: "/thumbs/g3.jpg", ballPos: { x: 1.5, y: 0.3, z: 4.05 } },
  { id: "graphic-project04", name: "Project G4", thumb: "/thumbs/g4.jpg", ballPos: { x: -1.65, y: -1.7, z: 3.46 } },
  { id: "graphic-project05", name: "Project G5", thumb: "/thumbs/g5.jpg", ballPos: { x: -0.45, y: 2.15, z: 4.5 } },
  { id: "graphic-project06", name: "Project G6", thumb: "/thumbs/g6.jpg", ballPos: { x: 1.1, y: -1.05, z: 3.7 } },
  { id: "graphic-project07", name: "Project G7", thumb: "/thumbs/g7.jpg", ballPos: { x: -1.56, y: 0.2, z: 3.95 } },
  { id: "graphic-project08", name: "Project G8", thumb: "/thumbs/g8.jpg", ballPos: { x: 1.5, y: 0.3, z: 2.5 } },
  { id: "graphic-project09", name: "Project G9", thumb: "/thumbs/g9.jpg", ballPos: { x: -0.45, y: 2.15, z: 0.0 } },
  { id: "graphic-project10", name: "Project G10", thumb: "/thumbs/g10.jpg", ballPos: { x: 2.0, y: -1.2, z: 3.7 } },
  { id: "graphic-project11", name: "Project G11", thumb: "/thumbs/g11.jpg", ballPos: { x: -0.61, y: -0.22, z: 0.0 } },
  { id: "graphic-project12", name: "Project G12", thumb: "/thumbs/g12.jpg", ballPos: { x: 0.55, y: -1.85, z: 2.5 } },
  { id: "graphic-project13", name: "Project G13", thumb: "/thumbs/g13.jpg", ballPos: { x: -1.7, y: -2.9, z: 3.1 } },
  { id: "graphic-project14", name: "Project G14", thumb: "/thumbs/g14.jpg", ballPos: { x: 0.1, y: -0.9, z: 0.5 } },
  { id: "graphic-project15", name: "Project G15", thumb: "/thumbs/g15.jpg", ballPos: { x: 1.2, y: -1.0, z: 0.6 } },
];
        ...
        <div className="relative z-10 w-full px-8 md:pl-16 md:pr-12 border-b border-white/5 pb-8 mt-4 pointer-events-none flex flex-col items-start">
          ...
          <div className="max-w-[280px] md:max-w-[320px] block mt-[20px]">
            ...
            <div className="text-[16px] text-white/50 font-light tracking-wide leading-relaxed block mt-4">
              ...
              <br />
              are structured graphic practices,
              <br />
              reinterpreting layout logic, visual communication,
              <br />
              and informational hierarchy across
              <br />
              diverse physical and digital formats.
            </div>
          </div>
        </div>
