...
export default function ProjectPosterPage() {
  ...
  const PROJECT_DATA = {
    ...
    meta: {
      titlePngSrc: "/photo/g/p08/title.png",
      titles: { cn: "Project G08", en: "Project G08", jp: "Project G08" },
      projectName: "Project G08",
      creationDate: "2025",
      client: "TBD",
    },
    descriptions: {
      cn: ["项目 G08 的详细设计说明。", "更多信息待补充。"],
      en: ["Detailed description for Project G08.", "More information coming soon."],
      jp: ["プロジェクトG08の詳細説明。", "詳細は追って追記予定。"],
    },
    mainPosters: [
      "/photo/g/p08/gp08-001.png",
      "/photo/g/p08/gp08-002.png",
    ],
    sketches: [
      { id: 1, src: "/photo/g/p08/detail-01.jpg", width: 180, rotate: -8, top: "20px", left: "5%" },
      { id: 2, src: "/photo/g/p08/detail-02.jpg", width: 220, rotate: 6, top: "0px", left: "40%" },
      { id: 3, src: "/photo/g/p08/detail-03.jpg", width: 160, rotate: -12, top: "40px", left: "70%" },
    ]
  };
