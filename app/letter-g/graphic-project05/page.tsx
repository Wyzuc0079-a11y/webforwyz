...
export default function Project05PosterPage() {
  ...
  const PROJECT_DATA = {
    ...
    meta: {
      titlePngSrc: "/photo/g/p05/title.png",
      titles: { cn: "Project G05", en: "Project G05", jp: "Project G05" },
      projectName: "Project G5",
      creationDate: "2025",
      client: "TBD",
    },
    descriptions: {
      cn: ["项目 G5 的详细设计说明。", "更多信息待补充。"],
      en: ["Detailed description for Project G5.", "More information coming soon."],
      jp: ["プロジェクトG5の詳細説明。", "詳細は追って追記予定。"],
    },
    mainPosters: [
      "/photo/g/p05/gp005-001.png",
      "/photo/g/p05/gp005-002.png",
    ],
    sketches: [
      { id: 1, src: "/photo/g/p05/detail-01.jpg", width: 180, rotate: -8, top: "20px", left: "5%" },
      { id: 2, src: "/photo/g/p05/detail-02.jpg", width: 220, rotate: 6, top: "0px", left: "40%" },
      { id: 3, src: "/photo/g/p05/detail-03.jpg", width: 160, rotate: -12, top: "40px", left: "70%" },
    ]
  };
          ...
          <div className="w-full md:w-2/3 space-y-12">
            {PROJECT_DATA.mainPosters.map((posterSrc, idx) => (
              ...
              >
                <img
                  src={posterSrc}
                  alt={`Project 05 poster view ${idx}`}
