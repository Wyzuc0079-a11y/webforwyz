...
export default function Project03PosterPage() {
  ...
  const PROJECT_DATA = {
    ...
    sketches: [
      ...
      { id: 2, src: "/photo/g/p03/detail-02.jpg", width: 220, rotate: 6, top: "0px", left: "40%" },
      { id: 3, src: "/photo/g/p03/detail-03.jpg", width: 160, rotate: -12, top: "40px", left: "70%" },
    ]
  };
          ...
          <div className="w-full md:w-2/3 space-y-12">
            {PROJECT_DATA.mainPosters.map((posterSrc, idx) => (
              ...
              >
                <img
                  src={posterSrc}
                  alt={`Project 03 poster view ${idx}`}
